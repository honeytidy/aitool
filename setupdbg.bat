...
set PYTHON_PATH="D:\soft\anaconda3\pythonw.exe"
...
reg add "HKEY_CLASSES_ROOT\*\shell\MyPythonAction\command" /ve /d "%PYTHON_PATH% %SCRIPT_PATH% \"%%1\"" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\shell\MyPythonAction\command" /ve /d "%PYTHON_PATH% %SCRIPT_PATH% \"%%1\"" /f
